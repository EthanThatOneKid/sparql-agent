...
SPARQL query results can be serialized in
[different formats](/docs/query/advanced/result_formats/). For all of these
supported formats, the following are standards:
...
Alignment with other JavaScript libraries is achieved via the following RDF/JS
specifications:
