...
When using
[Comunica from the command line](/docs/query/getting_started/query_cli/), the
result format can be set using the `-t` option:
...
When using
[Comunica in a JavaScript application](/docs/query/getting_started/query_app/),
