...
Using Comunica SPARQL File, you can query over RDF files that are stored on your
local machine.
...
including `comunica-sparql-file`, which allows you to execute SPARQL queries
...
This guide only discussed the basic functionality of `comunica-sparql-file`. You
